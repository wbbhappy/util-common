...
public class JSONUtils {
	 ...
	 */
	public static <T> List<T> json2map2list(String jsonArrayStr, Class<T> clazz) throws Exception {
	...
	public static <T> List<T> json2list(String jsonArrayStr, Class<T> clazz) throws Exception {
		List<T> result = objectMapper.readValue(jsonArrayStr, objectMapper.getTypeFactory().constructCollectionType(List.class, clazz));
		return result;
	}
