...
public class ValidateUtil {
	...
	public static void main(String[] args) {
		...
		System.out.println(str10 + ": " + isPassword(str10) + "+++长度"	+ str10.length());
		System.out.println(str11 + ": " + isPassword(str11) + "+++长度"	+ str11.length());*/
		...
		String qq4 = "0.1";
		String qq5 = "1";
		System.out.println(qq1 + " : " + isMONEY2(qq1));
		...
		System.out.println(str + ": " + isRealname(str) + "+++长度"	+ str.length());
